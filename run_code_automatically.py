...
if __name__ == '__main__':
    sleep_until_gpu_free([0, 0.2])
    print('done')

    # os.system('mv /raid/liuchuandong/code/sparse_net_1/output/kitti_models/pointrcnn_ssl /raid/liuchuandong/code/sparse_net_1/output/kitti_models/pointrcnn_ssl_18')
    os.system('cd /data/d1/duanwei/FRUA/some-resources-master; python attack_feat1.py')
    # time.sleep(600)

    # sleep_until_gpu_free([0.9, 0.9, 0.9, 0.9])
    # os.system('mv /raid/liuchuandong/code/sparse_net_1/data/kitti/kitti_infos_val.pkl /raid/liuchuandong/code/sparse_net_1/data/kitti/kitti_infos_val_final.pkl')
    # os.system('mv /raid/liuchuandong/code/sparse_net_1/data/kitti/kitti_infos_val_ori.pkl /raid/liuchuandong/code/sparse_net_1/data/kitti/kitti_infos_val.pkl')
    # os.system('sh scripts/dist_test.sh')
    #
    # sleep_until_gpu_free([0.0, 0.0, 0.9, 0.9])
    # print('done')
    # os.system('sh scripts/dist_test1.sh')
